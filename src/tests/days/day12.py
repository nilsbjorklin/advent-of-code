...
from src.days.day12.part_2 import run as part_2_run
...
class TestPart2(TestCase):
    def test_part_2_mini_1(self):
        self.assertEqual(80, part_2_run(test_data_mini.strip().splitlines()))

    def test_part_2_mini_2(self):
        self.assertEqual(436, part_2_run(test_data_mini_2.strip().splitlines()))

    def test_part_2_mini_3(self):
        self.assertEqual(236, part_2_run(test_data_mini_3.strip().splitlines()))

    def test_part_2_mini_4(self):
        self.assertEqual(368, part_2_run(test_data_mini_4.strip().splitlines()))

    def test_part_2(self):
        self.assertEqual(1206, part_2_run(test_data.strip().splitlines()))
